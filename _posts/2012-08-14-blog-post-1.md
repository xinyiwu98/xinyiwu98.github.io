...
Oversmoothing was something researchers noticed even back to the earliest days of GNNs, when Kipf and Welling introduced GCN. So what has been understood about this performance plot in the past? I summarize the related works as follows:
...
======
Message-passing homogenizes node represetnations. However, not all homogenization is created equal. We should distinguish between two kinds of homogenization:
